...
"""Принцип подстановки Лискова гарантирует, что подклассы или 
реализации могут заменить свои родительские классы или интерфейсы 
без изменения поведения программы. В этом проекте мы продемонстрируем,
 как применять LSP с помощью протоколов Python, и изучим проблемы, 
 связанные с поддержкой согласованных сигнатур методов."""
#Все процессоры реализуют единые интерфейсы Protocol
#Подтипы (Stripe/Offline) могут взаимозаменяться в PaymentService
@dataclass
